"""Consulta y exportación de la bitácora de auditoría (roles admin y auditor)."""
...
VER = Depends(requiere_permiso("auditoria.ver"))
POR_PAGINA = 50
...
def auditoria_export(
    ...
    audit.registrar(
        db, audit.AUDITORIA_EXPORTADA, request=request, usuario=usuario,
